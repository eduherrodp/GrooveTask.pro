...
const oauth2Client = new google.auth.OAuth2(
    ...
    'https://www.edhrrz.pro'
);

const code = 'code=4/0AeaYSHCmGwGZqMePbL0k5PAifDEYRd3GSMDKhWn00aPIKikTN0zwAGooXvT031hb5tJaZw'; // Código de autorización de la URL
...
oauth2Client.getToken(code, (err, tokens) => {
    if (err) {
        ...
        tasks.tasklists.list({}, (err, response) => {
            if (err) {
