 ...
 */
var oauth2Client = new google.auth.OAuth2('48778211564-of75cphljno4hqfk96pcb41a3saoss0g.apps.googleusercontent.com', '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', 'https://api.edhrrz.pro');
...
rl.question('Enter the authorization code:', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(code) {
    var _yield$oauth2Client$g, tokens, tasks, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 16:
          ...
          console.error('Error retrieving access token:', _context.t0);
        case 19:
        case "end":
