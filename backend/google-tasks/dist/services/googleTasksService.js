 ...
 */
var GoogleTasksService = /*#__PURE__*/function () {
  function GoogleTasksService() {
    _classCallCheck(this, GoogleTasksService);
  }
  _createClass(GoogleTasksService, [{
    key: "getTaskLists",
    value: (
    /**
     * Get all task lists.
    ...
    value: (function () {
      ...
      function updateTaskList(_x2, _x3) {
    ...
    value: (function () {
      ...
      function updateTask(_x8, _x9, _x10) {
