...
var _require3 = require('firebase/database'),
  getDatabase = _require3.getDatabase,
  ref = _require3.ref,
  set = _require3.set;
...
appExpress.post('/signup', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, email, password, username, userCredential, user, errorMessage;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          user = userCredential.user; // Guarda los datos adicionales del usuario en la base de datos
          _context.next = 8;
          return set(ref(db, "users/".concat(user.uid)), {
            email: user.email,
            username: username
          });
        case 8:
